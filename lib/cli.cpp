...
std::vector<std::string> vxldollar::config_overrides (std::vector<config_key_value_pair> const & key_value_pairs_a)
{
...
std::istream & vxldollar::operator>> (std::istream & is, vxldollar::config_key_value_pair & into)
{
	char ch;
	while (is >> ch && ch != '=')
	{
