...
inline double to_multiplier (vxldollar_pow_server::u128 const difficulty_a, vxldollar_pow_server::u128 const base_difficulty_a)
{
...
inline vxldollar_pow_server::u128 from_multiplier (double const multiplier_a, vxldollar_pow_server::u128 const base_difficulty_a)
{
