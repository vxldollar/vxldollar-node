...
boost::filesystem::path working_path (vxldollar::networks network = vxldollar::network_constants::active_network);
// Get a unique path within the home directory, used for testing.
// Any directories created at this location will be removed when a test finishes.
boost::filesystem::path unique_path (vxldollar::networks network = vxldollar::network_constants::active_network);
