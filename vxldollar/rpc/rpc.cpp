...
vxldollar::rpc::rpc (boost::asio::io_context & io_ctx_a, vxldollar::rpc_config config_a, vxldollar::rpc_handler_interface & rpc_handler_interface_a) :
...
void vxldollar::rpc::accept ()
{
	auto connection (std::make_shared<vxldollar::rpc_connection> (config, io_ctx, logger, rpc_handler_interface));
...
void vxldollar::rpc::stop ()
{
	stopped = true;
	acceptor.close ();
}

std::unique_ptr<vxldollar::rpc> vxldollar::get_rpc (boost::asio::io_context & io_ctx_a, vxldollar::rpc_config const & config_a, vxldollar::rpc_handler_interface & rpc_handler_interface_a)
{
