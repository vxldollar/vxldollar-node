...
template <typename T>
bool try_read (vxldollar::stream & stream_a, T & value_a)
{
...
template <typename T>
void read (vxldollar::stream & stream_a, T & value)
{
...
inline void read (vxldollar::stream & stream_a, std::vector<uint8_t> & value_a, size_t size_a)
{
...
template <typename T>
void write (vxldollar::stream & stream_a, T const & value_a)
{
...
inline void write (vxldollar::stream & stream_a, std::vector<uint8_t> const & value_a)
{
