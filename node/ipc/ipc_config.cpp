...
vxldollar::error vxldollar::ipc::ipc_config::serialize_toml (vxldollar::tomlconfig & toml) const
{
	vxldollar::tomlconfig tcp_l;
	...
	vxldollar::tomlconfig flatbuffers_l;
...
vxldollar::error vxldollar::ipc::ipc_config::deserialize_toml (vxldollar::tomlconfig & toml)
{
