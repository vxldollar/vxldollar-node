...
#include <vxldollar/boost/beast/core.hpp>
#include <vxldollar/boost/beast/websocket.hpp>
...
namespace vxldollar::websocket
{
/** The minimal stream interface needed by the Vxldollar websocket implementation */
...
public:
	...
	virtual void async_write (vxldollar::shared_const_buffer const & buffer_a, std::function<void (boost::system::error_code, std::size_t)> callback_a) = 0;
