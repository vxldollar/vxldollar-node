...
#ifndef FLATBUFFERS_GENERATED_VXLDOLLARAPI_VXLDOLLARAPI_H_
#define FLATBUFFERS_GENERATED_VXLDOLLARAPI_VXLDOLLARAPI_H_

#include "flatbuffers/flatbuffers.h"

namespace vxldollarapi {
...
template<> struct BlockTraits<vxldollarapi::BlockState> {
  static const Block enum_value = Block_BlockState;
};

template<> struct BlockTraits<vxldollarapi::BlockOpen> {
  static const Block enum_value = Block_BlockOpen;
};

template<> struct BlockTraits<vxldollarapi::BlockReceive> {
  static const Block enum_value = Block_BlockReceive;
};

template<> struct BlockTraits<vxldollarapi::BlockSend> {
  static const Block enum_value = Block_BlockSend;
};

template<> struct BlockTraits<vxldollarapi::BlockChange> {
...
struct BlockUnion {
  ...
  vxldollarapi::BlockStateT *AsBlockState() {
    return type == Block_BlockState ?
      reinterpret_cast<vxldollarapi::BlockStateT *>(value) : nullptr;
  }
  const vxldollarapi::BlockStateT *AsBlockState() const {
    return type == Block_BlockState ?
      reinterpret_cast<const vxldollarapi::BlockStateT *>(value) : nullptr;
  }
  vxldollarapi::BlockOpenT *AsBlockOpen() {
    return type == Block_BlockOpen ?
      reinterpret_cast<vxldollarapi::BlockOpenT *>(value) : nullptr;
  }
  const vxldollarapi::BlockOpenT *AsBlockOpen() const {
    return type == Block_BlockOpen ?
      reinterpret_cast<const vxldollarapi::BlockOpenT *>(value) : nullptr;
  }
  vxldollarapi::BlockReceiveT *AsBlockReceive() {
    return type == Block_BlockReceive ?
      reinterpret_cast<vxldollarapi::BlockReceiveT *>(value) : nullptr;
  }
  const vxldollarapi::BlockReceiveT *AsBlockReceive() const {
    return type == Block_BlockReceive ?
      reinterpret_cast<const vxldollarapi::BlockReceiveT *>(value) : nullptr;
  }
  vxldollarapi::BlockSendT *AsBlockSend() {
    return type == Block_BlockSend ?
      reinterpret_cast<vxldollarapi::BlockSendT *>(value) : nullptr;
  }
  const vxldollarapi::BlockSendT *AsBlockSend() const {
    return type == Block_BlockSend ?
      reinterpret_cast<const vxldollarapi::BlockSendT *>(value) : nullptr;
  }
  vxldollarapi::BlockChangeT *AsBlockChange() {
    return type == Block_BlockChange ?
      reinterpret_cast<vxldollarapi::BlockChangeT *>(value) : nullptr;
  }
  const vxldollarapi::BlockChangeT *AsBlockChange() const {
    return type == Block_BlockChange ?
      reinterpret_cast<const vxldollarapi::BlockChangeT *>(value) : nullptr;
  }
};
...
template<> struct MessageTraits<vxldollarapi::Error> {
  static const Message enum_value = Message_Error;
};

template<> struct MessageTraits<vxldollarapi::Success> {
  static const Message enum_value = Message_Success;
};

template<> struct MessageTraits<vxldollarapi::IsAlive> {
  static const Message enum_value = Message_IsAlive;
};

template<> struct MessageTraits<vxldollarapi::EventAck> {
  static const Message enum_value = Message_EventAck;
};

template<> struct MessageTraits<vxldollarapi::BlockInfo> {
  static const Message enum_value = Message_BlockInfo;
};

template<> struct MessageTraits<vxldollarapi::AccountWeight> {
  static const Message enum_value = Message_AccountWeight;
};

template<> struct MessageTraits<vxldollarapi::AccountWeightResponse> {
  static const Message enum_value = Message_AccountWeightResponse;
};

template<> struct MessageTraits<vxldollarapi::TopicConfirmation> {
  static const Message enum_value = Message_TopicConfirmation;
};

template<> struct MessageTraits<vxldollarapi::EventConfirmation> {
  static const Message enum_value = Message_EventConfirmation;
};

template<> struct MessageTraits<vxldollarapi::ServiceRegister> {
  static const Message enum_value = Message_ServiceRegister;
};

template<> struct MessageTraits<vxldollarapi::ServiceStop> {
  static const Message enum_value = Message_ServiceStop;
};

template<> struct MessageTraits<vxldollarapi::TopicServiceStop> {
  static const Message enum_value = Message_TopicServiceStop;
};

template<> struct MessageTraits<vxldollarapi::EventServiceStop> {
...
struct MessageUnion {
  ...
  vxldollarapi::ErrorT *AsError() {
    return type == Message_Error ?
      reinterpret_cast<vxldollarapi::ErrorT *>(value) : nullptr;
  }
  const vxldollarapi::ErrorT *AsError() const {
    return type == Message_Error ?
      reinterpret_cast<const vxldollarapi::ErrorT *>(value) : nullptr;
  }
  vxldollarapi::SuccessT *AsSuccess() {
    return type == Message_Success ?
      reinterpret_cast<vxldollarapi::SuccessT *>(value) : nullptr;
  }
  const vxldollarapi::SuccessT *AsSuccess() const {
    return type == Message_Success ?
      reinterpret_cast<const vxldollarapi::SuccessT *>(value) : nullptr;
  }
  vxldollarapi::IsAliveT *AsIsAlive() {
    return type == Message_IsAlive ?
      reinterpret_cast<vxldollarapi::IsAliveT *>(value) : nullptr;
  }
  const vxldollarapi::IsAliveT *AsIsAlive() const {
    return type == Message_IsAlive ?
      reinterpret_cast<const vxldollarapi::IsAliveT *>(value) : nullptr;
  }
  vxldollarapi::EventAckT *AsEventAck() {
    return type == Message_EventAck ?
      reinterpret_cast<vxldollarapi::EventAckT *>(value) : nullptr;
  }
  const vxldollarapi::EventAckT *AsEventAck() const {
    return type == Message_EventAck ?
      reinterpret_cast<const vxldollarapi::EventAckT *>(value) : nullptr;
  }
  vxldollarapi::BlockInfoT *AsBlockInfo() {
    return type == Message_BlockInfo ?
      reinterpret_cast<vxldollarapi::BlockInfoT *>(value) : nullptr;
  }
  const vxldollarapi::BlockInfoT *AsBlockInfo() const {
    return type == Message_BlockInfo ?
      reinterpret_cast<const vxldollarapi::BlockInfoT *>(value) : nullptr;
  }
  vxldollarapi::AccountWeightT *AsAccountWeight() {
    return type == Message_AccountWeight ?
      reinterpret_cast<vxldollarapi::AccountWeightT *>(value) : nullptr;
  }
  const vxldollarapi::AccountWeightT *AsAccountWeight() const {
    return type == Message_AccountWeight ?
      reinterpret_cast<const vxldollarapi::AccountWeightT *>(value) : nullptr;
  }
  vxldollarapi::AccountWeightResponseT *AsAccountWeightResponse() {
    return type == Message_AccountWeightResponse ?
      reinterpret_cast<vxldollarapi::AccountWeightResponseT *>(value) : nullptr;
  }
  const vxldollarapi::AccountWeightResponseT *AsAccountWeightResponse() const {
    return type == Message_AccountWeightResponse ?
      reinterpret_cast<const vxldollarapi::AccountWeightResponseT *>(value) : nullptr;
  }
  vxldollarapi::TopicConfirmationT *AsTopicConfirmation() {
    return type == Message_TopicConfirmation ?
      reinterpret_cast<vxldollarapi::TopicConfirmationT *>(value) : nullptr;
  }
  const vxldollarapi::TopicConfirmationT *AsTopicConfirmation() const {
    return type == Message_TopicConfirmation ?
      reinterpret_cast<const vxldollarapi::TopicConfirmationT *>(value) : nullptr;
  }
  vxldollarapi::EventConfirmationT *AsEventConfirmation() {
    return type == Message_EventConfirmation ?
      reinterpret_cast<vxldollarapi::EventConfirmationT *>(value) : nullptr;
  }
  const vxldollarapi::EventConfirmationT *AsEventConfirmation() const {
    return type == Message_EventConfirmation ?
      reinterpret_cast<const vxldollarapi::EventConfirmationT *>(value) : nullptr;
  }
  vxldollarapi::ServiceRegisterT *AsServiceRegister() {
    return type == Message_ServiceRegister ?
      reinterpret_cast<vxldollarapi::ServiceRegisterT *>(value) : nullptr;
  }
  const vxldollarapi::ServiceRegisterT *AsServiceRegister() const {
    return type == Message_ServiceRegister ?
      reinterpret_cast<const vxldollarapi::ServiceRegisterT *>(value) : nullptr;
  }
  vxldollarapi::ServiceStopT *AsServiceStop() {
    return type == Message_ServiceStop ?
      reinterpret_cast<vxldollarapi::ServiceStopT *>(value) : nullptr;
  }
  const vxldollarapi::ServiceStopT *AsServiceStop() const {
    return type == Message_ServiceStop ?
      reinterpret_cast<const vxldollarapi::ServiceStopT *>(value) : nullptr;
  }
  vxldollarapi::TopicServiceStopT *AsTopicServiceStop() {
    return type == Message_TopicServiceStop ?
      reinterpret_cast<vxldollarapi::TopicServiceStopT *>(value) : nullptr;
  }
  const vxldollarapi::TopicServiceStopT *AsTopicServiceStop() const {
    return type == Message_TopicServiceStop ?
      reinterpret_cast<const vxldollarapi::TopicServiceStopT *>(value) : nullptr;
  }
  vxldollarapi::EventServiceStopT *AsEventServiceStop() {
    return type == Message_EventServiceStop ?
      reinterpret_cast<vxldollarapi::EventServiceStopT *>(value) : nullptr;
  }
  const vxldollarapi::EventServiceStopT *AsEventServiceStop() const {
    return type == Message_EventServiceStop ?
      reinterpret_cast<const vxldollarapi::EventServiceStopT *>(value) : nullptr;
  }
};
...
struct AccountWeightT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.AccountWeightT";
  }
  std::string account{};
};
...
struct AccountWeight FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.AccountWeight";
  }
...
inline flatbuffers::Offset<AccountWeight> CreateAccountWeightDirect(
  ...
  return vxldollarapi::CreateAccountWeight(
      _fbb,
      account__);
}
...
struct AccountWeightResponseT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.AccountWeightResponseT";
  }
...
struct AccountWeightResponse FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.AccountWeightResponse";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_VOTING_WEIGHT = 4
  };
...
inline flatbuffers::Offset<AccountWeightResponse> CreateAccountWeightResponseDirect(
  ...
  return vxldollarapi::CreateAccountWeightResponse(
      _fbb,
      voting_weight__);
}
...
struct BlockOpenT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.BlockOpenT";
  }
  std::string hash{};
  std::string account{};
  std::string source{};
...
inline flatbuffers::Offset<BlockOpen> CreateBlockOpenDirect(
  ...
  return vxldollarapi::CreateBlockOpen(
      _fbb,
      hash__,
      account__,
      source__,
...
struct BlockReceiveT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.BlockReceiveT";
  }
  std::string hash{};
  std::string previous{};
  std::string source{};
...
struct BlockReceive FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.BlockReceive";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_HASH = 4,
    VT_PREVIOUS = 6,
...
inline flatbuffers::Offset<BlockReceive> CreateBlockReceiveDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vxldollarapi::CreateBlockReceive(
      _fbb,
      hash__,
      previous__,
      source__,
...
struct BlockSendT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.BlockSendT";
  }
  std::string hash{};
  std::string previous{};
...
inline flatbuffers::Offset<BlockSend> CreateBlockSendDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vxldollarapi::CreateBlockSend(
      _fbb,
      hash__,
      previous__,
      destination__,
...
struct BlockChangeT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.BlockChangeT";
  }
  std::string hash{};
  std::string previous{};
  std::string representative{};
...
struct BlockChange FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.BlockChange";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_HASH = 4,
    VT_PREVIOUS = 6,
...
inline flatbuffers::Offset<BlockChange> CreateBlockChangeDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vxldollarapi::CreateBlockChange(
      _fbb,
      hash__,
      previous__,
      representative__,
...
struct BlockStateT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.BlockStateT";
  }
  std::string hash{};
  std::string account{};
  std::string previous{};
  ...
  std::string signature{};
  std::string work{};
  vxldollarapi::BlockSubType subtype = vxldollarapi::BlockSubType_invalid;
};
...
struct BlockState FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.BlockState";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_HASH = 4,
    VT_ACCOUNT = 6,
  ...
  vxldollarapi::BlockSubType subtype() const {
    return static_cast<vxldollarapi::BlockSubType>(GetField<int8_t>(VT_SUBTYPE, 0));
  }
  bool mutate_subtype(vxldollarapi::BlockSubType _subtype) {
...
struct BlockStateBuilder {
  ...
  void add_subtype(vxldollarapi::BlockSubType subtype) {
...
inline flatbuffers::Offset<BlockState> CreateBlockStateDirect(
  ...
  auto signature__ = signature ? _fbb.CreateString(signature) : 0;
  auto work__ = work ? _fbb.CreateString(work) : 0;
  return vxldollarapi::CreateBlockState(
      _fbb,
      hash__,
      account__,
      previous__,
...
struct BlockInfoT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.BlockInfoT";
  }
...
struct BlockInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.BlockInfo";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_BLOCK_TYPE = 4,
    VT_BLOCK = 6
  };
  vxldollarapi::Block block_type() const {
    return static_cast<vxldollarapi::Block>(GetField<uint8_t>(VT_BLOCK_TYPE, 0));
  }
  const void *block() const {
    return GetPointer<const void *>(VT_BLOCK);
  }
  template<typename T> const T *block_as() const;
  const vxldollarapi::BlockState *block_as_BlockState() const {
    return block_type() == vxldollarapi::Block_BlockState ? static_cast<const vxldollarapi::BlockState *>(block()) : nullptr;
  }
  const vxldollarapi::BlockOpen *block_as_BlockOpen() const {
    return block_type() == vxldollarapi::Block_BlockOpen ? static_cast<const vxldollarapi::BlockOpen *>(block()) : nullptr;
  }
  const vxldollarapi::BlockReceive *block_as_BlockReceive() const {
    return block_type() == vxldollarapi::Block_BlockReceive ? static_cast<const vxldollarapi::BlockReceive *>(block()) : nullptr;
  }
  const vxldollarapi::BlockSend *block_as_BlockSend() const {
    return block_type() == vxldollarapi::Block_BlockSend ? static_cast<const vxldollarapi::BlockSend *>(block()) : nullptr;
  }
  const vxldollarapi::BlockChange *block_as_BlockChange() const {
    return block_type() == vxldollarapi::Block_BlockChange ? static_cast<const vxldollarapi::BlockChange *>(block()) : nullptr;
  }
  void *mutable_block() {
...
template<> inline const vxldollarapi::BlockState *BlockInfo::block_as<vxldollarapi::BlockState>() const {
  return block_as_BlockState();
}

template<> inline const vxldollarapi::BlockOpen *BlockInfo::block_as<vxldollarapi::BlockOpen>() const {
  return block_as_BlockOpen();
}

template<> inline const vxldollarapi::BlockReceive *BlockInfo::block_as<vxldollarapi::BlockReceive>() const {
  return block_as_BlockReceive();
}

template<> inline const vxldollarapi::BlockSend *BlockInfo::block_as<vxldollarapi::BlockSend>() const {
  return block_as_BlockSend();
}

template<> inline const vxldollarapi::BlockChange *BlockInfo::block_as<vxldollarapi::BlockChange>() const {
...
struct BlockInfoBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_block_type(vxldollarapi::Block block_type) {
...
inline flatbuffers::Offset<BlockInfo> CreateBlockInfo(
    flatbuffers::FlatBufferBuilder &_fbb,
    vxldollarapi::Block block_type = vxldollarapi::Block_NONE,
...
struct ServiceRegisterT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.ServiceRegisterT";
  }
...
struct ServiceRegister FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.ServiceRegister";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SERVICE_NAME = 4
  };
...
inline flatbuffers::Offset<ServiceRegister> CreateServiceRegisterDirect(
  ...
  return vxldollarapi::CreateServiceRegister(
      _fbb,
      service_name__);
}
...
struct ServiceStopT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.ServiceStopT";
  }
  std::string service_name{};
  bool restart = false;
};
...
struct ServiceStop FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.ServiceStop";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SERVICE_NAME = 4,
    VT_RESTART = 6
...
inline flatbuffers::Offset<ServiceStop> CreateServiceStopDirect(
    ...
    bool restart = false) {
  auto service_name__ = service_name ? _fbb.CreateString(service_name) : 0;
  return vxldollarapi::CreateServiceStop(
      _fbb,
      service_name__,
      restart);
}
...
struct TopicServiceStopT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.TopicServiceStopT";
  }
...
struct TopicServiceStop FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.TopicServiceStop";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_UNSUBSCRIBE = 4
  };
...
struct EventServiceStopT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.EventServiceStopT";
  }
};
...
struct EventServiceStop FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.EventServiceStop";
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           verifier.EndTable();
...
struct TopicConfirmationT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.TopicConfirmationT";
  }
  bool unsubscribe = false;
  std::unique_ptr<vxldollarapi::TopicConfirmationOptionsT> options{};
};
...
struct TopicConfirmation FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.TopicConfirmation";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_UNSUBSCRIBE = 4,
    VT_OPTIONS = 6
  ...
  const vxldollarapi::TopicConfirmationOptions *options() const {
    return GetPointer<const vxldollarapi::TopicConfirmationOptions *>(VT_OPTIONS);
  }
  vxldollarapi::TopicConfirmationOptions *mutable_options() {
    return GetPointer<vxldollarapi::TopicConfirmationOptions *>(VT_OPTIONS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_UNSUBSCRIBE) &&
...
struct TopicConfirmationBuilder {
  ...
  void add_options(flatbuffers::Offset<vxldollarapi::TopicConfirmationOptions> options) {
...
inline flatbuffers::Offset<TopicConfirmation> CreateTopicConfirmation(
    flatbuffers::FlatBufferBuilder &_fbb,
    bool unsubscribe = false,
    flatbuffers::Offset<vxldollarapi::TopicConfirmationOptions> options = 0) {
...
struct TopicConfirmationOptionsT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.TopicConfirmationOptionsT";
  }
  vxldollarapi::TopicConfirmationTypeFilter confirmation_type_filter = vxldollarapi::TopicConfirmationTypeFilter_all;
...
struct TopicConfirmationOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.TopicConfirmationOptions";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
  ...
  vxldollarapi::TopicConfirmationTypeFilter confirmation_type_filter() const {
    return static_cast<vxldollarapi::TopicConfirmationTypeFilter>(GetField<int8_t>(VT_CONFIRMATION_TYPE_FILTER, 0));
  }
  bool mutate_confirmation_type_filter(vxldollarapi::TopicConfirmationTypeFilter _confirmation_type_filter) {
...
struct TopicConfirmationOptionsBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_confirmation_type_filter(vxldollarapi::TopicConfirmationTypeFilter confirmation_type_filter) {
...
inline flatbuffers::Offset<TopicConfirmationOptions> CreateTopicConfirmationOptionsDirect(
  ...
  return vxldollarapi::CreateTopicConfirmationOptions(
      _fbb,
...
struct EventConfirmationT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.EventConfirmationT";
  }
  vxldollarapi::TopicConfirmationType confirmation_type = vxldollarapi::TopicConfirmationType_active_quorum;
  std::string account{};
  std::string amount{};
  std::string hash{};
  vxldollarapi::BlockUnion block{};
  std::unique_ptr<vxldollarapi::ElectionInfoT> election_info{};
};
...
struct EventConfirmation FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.EventConfirmation";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
  ...
  vxldollarapi::TopicConfirmationType confirmation_type() const {
    return static_cast<vxldollarapi::TopicConfirmationType>(GetField<int8_t>(VT_CONFIRMATION_TYPE, 0));
  }
  bool mutate_confirmation_type(vxldollarapi::TopicConfirmationType _confirmation_type) {
  ...
  const vxldollarapi::ElectionInfo *election_info() const {
    return GetPointer<const vxldollarapi::ElectionInfo *>(VT_ELECTION_INFO);
  }
  vxldollarapi::ElectionInfo *mutable_election_info() {
    return GetPointer<vxldollarapi::ElectionInfo *>(VT_ELECTION_INFO);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const vxldollarapi::BlockState *EventConfirmation::block_as<vxldollarapi::BlockState>() const {
  return block_as_BlockState();
}

template<> inline const vxldollarapi::BlockOpen *EventConfirmation::block_as<vxldollarapi::BlockOpen>() const {
  return block_as_BlockOpen();
}

template<> inline const vxldollarapi::BlockReceive *EventConfirmation::block_as<vxldollarapi::BlockReceive>() const {
  return block_as_BlockReceive();
}

template<> inline const vxldollarapi::BlockSend *EventConfirmation::block_as<vxldollarapi::BlockSend>() const {
  return block_as_BlockSend();
}

template<> inline const vxldollarapi::BlockChange *EventConfirmation::block_as<vxldollarapi::BlockChange>() const {
  return block_as_BlockChange();
}
...
struct EventConfirmationBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_confirmation_type(vxldollarapi::TopicConfirmationType confirmation_type) {
  ...
  void add_election_info(flatbuffers::Offset<vxldollarapi::ElectionInfo> election_info) {
...
inline flatbuffers::Offset<EventConfirmation> CreateEventConfirmation(
    ...
    vxldollarapi::Block block_type = vxldollarapi::Block_NONE,
    flatbuffers::Offset<void> block = 0,
    flatbuffers::Offset<vxldollarapi::ElectionInfo> election_info = 0) {
...
inline flatbuffers::Offset<EventConfirmation> CreateEventConfirmationDirect(
  ...
  auto hash__ = hash ? _fbb.CreateString(hash) : 0;
  return vxldollarapi::CreateEventConfirmation(
      _fbb,
      confirmation_type,
      account__,
      amount__,
...
struct ElectionInfoT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.ElectionInfoT";
  }
  uint64_t duration = 0;
  uint64_t time = 0;
  std::string tally{};
...
struct ElectionInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.ElectionInfo";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_DURATION = 4,
    VT_TIME = 6,
...
inline flatbuffers::Offset<ElectionInfo> CreateElectionInfoDirect(
  ...
  return vxldollarapi::CreateElectionInfo(
      _fbb,
      duration,
      time,
      tally__,
...
inline flatbuffers::Offset<Error> CreateErrorDirect(
  ...
  return vxldollarapi::CreateError(
      _fbb,
      code,
      category,
      message__);
...
inline flatbuffers::Offset<Success> CreateSuccessDirect(
    ...
    const char *message = nullptr) {
  auto message__ = message ? _fbb.CreateString(message) : 0;
  return vxldollarapi::CreateSuccess(
      _fbb,
      message__);
}
...
struct EnvelopeT : public flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR const char *GetFullyQualifiedName() {
    return "vxldollarapi.EnvelopeT";
  }
  uint64_t time = 0;
  std::string credentials{};
  std::string correlation_id{};
  vxldollarapi::MessageUnion message{};
};
...
struct Envelope FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  vxldollarapi::Message message_type() const {
    return static_cast<vxldollarapi::Message>(GetField<uint8_t>(VT_MESSAGE_TYPE, 0));
  }
  const void *message() const {
    return GetPointer<const void *>(VT_MESSAGE);
  }
  template<typename T> const T *message_as() const;
  const vxldollarapi::Error *message_as_Error() const {
    return message_type() == vxldollarapi::Message_Error ? static_cast<const vxldollarapi::Error *>(message()) : nullptr;
  }
  const vxldollarapi::Success *message_as_Success() const {
    return message_type() == vxldollarapi::Message_Success ? static_cast<const vxldollarapi::Success *>(message()) : nullptr;
  }
  const vxldollarapi::IsAlive *message_as_IsAlive() const {
    return message_type() == vxldollarapi::Message_IsAlive ? static_cast<const vxldollarapi::IsAlive *>(message()) : nullptr;
  }
  const vxldollarapi::EventAck *message_as_EventAck() const {
    return message_type() == vxldollarapi::Message_EventAck ? static_cast<const vxldollarapi::EventAck *>(message()) : nullptr;
  }
  const vxldollarapi::BlockInfo *message_as_BlockInfo() const {
    return message_type() == vxldollarapi::Message_BlockInfo ? static_cast<const vxldollarapi::BlockInfo *>(message()) : nullptr;
  }
  const vxldollarapi::AccountWeight *message_as_AccountWeight() const {
    return message_type() == vxldollarapi::Message_AccountWeight ? static_cast<const vxldollarapi::AccountWeight *>(message()) : nullptr;
  }
  const vxldollarapi::AccountWeightResponse *message_as_AccountWeightResponse() const {
    return message_type() == vxldollarapi::Message_AccountWeightResponse ? static_cast<const vxldollarapi::AccountWeightResponse *>(message()) : nullptr;
  }
  const vxldollarapi::TopicConfirmation *message_as_TopicConfirmation() const {
    return message_type() == vxldollarapi::Message_TopicConfirmation ? static_cast<const vxldollarapi::TopicConfirmation *>(message()) : nullptr;
  }
  const vxldollarapi::EventConfirmation *message_as_EventConfirmation() const {
    return message_type() == vxldollarapi::Message_EventConfirmation ? static_cast<const vxldollarapi::EventConfirmation *>(message()) : nullptr;
  }
  const vxldollarapi::ServiceRegister *message_as_ServiceRegister() const {
    return message_type() == vxldollarapi::Message_ServiceRegister ? static_cast<const vxldollarapi::ServiceRegister *>(message()) : nullptr;
  }
  const vxldollarapi::ServiceStop *message_as_ServiceStop() const {
    return message_type() == vxldollarapi::Message_ServiceStop ? static_cast<const vxldollarapi::ServiceStop *>(message()) : nullptr;
  }
  const vxldollarapi::TopicServiceStop *message_as_TopicServiceStop() const {
    return message_type() == vxldollarapi::Message_TopicServiceStop ? static_cast<const vxldollarapi::TopicServiceStop *>(message()) : nullptr;
  }
  const vxldollarapi::EventServiceStop *message_as_EventServiceStop() const {
    return message_type() == vxldollarapi::Message_EventServiceStop ? static_cast<const vxldollarapi::EventServiceStop *>(message()) : nullptr;
  }
...
template<> inline const vxldollarapi::Error *Envelope::message_as<vxldollarapi::Error>() const {
  return message_as_Error();
}

template<> inline const vxldollarapi::Success *Envelope::message_as<vxldollarapi::Success>() const {
  return message_as_Success();
}

template<> inline const vxldollarapi::IsAlive *Envelope::message_as<vxldollarapi::IsAlive>() const {
  return message_as_IsAlive();
}

template<> inline const vxldollarapi::EventAck *Envelope::message_as<vxldollarapi::EventAck>() const {
  return message_as_EventAck();
}

template<> inline const vxldollarapi::BlockInfo *Envelope::message_as<vxldollarapi::BlockInfo>() const {
  return message_as_BlockInfo();
}

template<> inline const vxldollarapi::AccountWeight *Envelope::message_as<vxldollarapi::AccountWeight>() const {
  return message_as_AccountWeight();
}

template<> inline const vxldollarapi::AccountWeightResponse *Envelope::message_as<vxldollarapi::AccountWeightResponse>() const {
  return message_as_AccountWeightResponse();
}

template<> inline const vxldollarapi::TopicConfirmation *Envelope::message_as<vxldollarapi::TopicConfirmation>() const {
  return message_as_TopicConfirmation();
}

template<> inline const vxldollarapi::EventConfirmation *Envelope::message_as<vxldollarapi::EventConfirmation>() const {
  return message_as_EventConfirmation();
}

template<> inline const vxldollarapi::ServiceRegister *Envelope::message_as<vxldollarapi::ServiceRegister>() const {
  return message_as_ServiceRegister();
}

template<> inline const vxldollarapi::ServiceStop *Envelope::message_as<vxldollarapi::ServiceStop>() const {
  return message_as_ServiceStop();
}

template<> inline const vxldollarapi::TopicServiceStop *Envelope::message_as<vxldollarapi::TopicServiceStop>() const {
  return message_as_TopicServiceStop();
}

template<> inline const vxldollarapi::EventServiceStop *Envelope::message_as<vxldollarapi::EventServiceStop>() const {
...
struct EnvelopeBuilder {
  ...
  void add_message_type(vxldollarapi::Message message_type) {
...
inline flatbuffers::Offset<Envelope> CreateEnvelope(
    ...
    vxldollarapi::Message message_type = vxldollarapi::Message_NONE,
...
inline flatbuffers::Offset<Envelope> CreateEnvelopeDirect(
  ...
  return vxldollarapi::CreateEnvelope(
      _fbb,
      time,
      credentials__,
      correlation_id__,
...
inline void BlockInfo::UnPackTo(BlockInfoT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = block(); if (_e) _o->block.value = vxldollarapi::BlockUnion::UnPack(_e, block_type(), _resolver); }
}
...
inline flatbuffers::Offset<BlockInfo> CreateBlockInfo(flatbuffers::FlatBufferBuilder &_fbb, const BlockInfoT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vxldollarapi::CreateBlockInfo(
      _fbb,
      _block_type,
      _block);
}
...
inline flatbuffers::Offset<TopicServiceStop> CreateTopicServiceStop(flatbuffers::FlatBufferBuilder &_fbb, const TopicServiceStopT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vxldollarapi::CreateTopicServiceStop(
      _fbb,
      _unsubscribe);
}
...
inline flatbuffers::Offset<EventServiceStop> CreateEventServiceStop(flatbuffers::FlatBufferBuilder &_fbb, const EventServiceStopT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vxldollarapi::CreateEventServiceStop(
      _fbb);
}
...
inline flatbuffers::Offset<EventAck> CreateEventAck(flatbuffers::FlatBufferBuilder &_fbb, const EventAckT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vxldollarapi::CreateEventAck(
      _fbb);
}
...
inline void TopicConfirmation::UnPackTo(TopicConfirmationT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = unsubscribe(); _o->unsubscribe = _e; }
  { auto _e = options(); if (_e) _o->options = std::unique_ptr<vxldollarapi::TopicConfirmationOptionsT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<TopicConfirmation> CreateTopicConfirmation(flatbuffers::FlatBufferBuilder &_fbb, const TopicConfirmationT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vxldollarapi::CreateTopicConfirmation(
      _fbb,
      _unsubscribe,
      _options);
}
...
inline void EventConfirmation::UnPackTo(EventConfirmationT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = block_type(); _o->block.type = _e; }
  { auto _e = block(); if (_e) _o->block.value = vxldollarapi::BlockUnion::UnPack(_e, block_type(), _resolver); }
  { auto _e = election_info(); if (_e) _o->election_info = std::unique_ptr<vxldollarapi::ElectionInfoT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<IsAlive> CreateIsAlive(flatbuffers::FlatBufferBuilder &_fbb, const IsAliveT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  return vxldollarapi::CreateIsAlive(
      _fbb);
}
...
inline void Envelope::UnPackTo(EnvelopeT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = message(); if (_e) _o->message.value = vxldollarapi::MessageUnion::UnPack(_e, message_type(), _resolver); }
}
...
inline bool VerifyBlock(flatbuffers::Verifier &verifier, const void *obj, Block type) {
  switch (type) {
    ...
    case Block_BlockState: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockState *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockOpen *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockReceive *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockSend *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockChange *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline flatbuffers::Offset<void> BlockUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case Block_BlockState: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockStateT *>(value);
      return CreateBlockState(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockOpenT *>(value);
      return CreateBlockOpen(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockReceiveT *>(value);
      return CreateBlockReceive(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockSendT *>(value);
      return CreateBlockSend(_fbb, ptr, _rehasher).Union();
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockChangeT *>(value);
...
inline BlockUnion::BlockUnion(const BlockUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case Block_BlockState: {
      value = new vxldollarapi::BlockStateT(*reinterpret_cast<vxldollarapi::BlockStateT *>(u.value));
      break;
    }
    case Block_BlockOpen: {
      value = new vxldollarapi::BlockOpenT(*reinterpret_cast<vxldollarapi::BlockOpenT *>(u.value));
      break;
    }
    case Block_BlockReceive: {
      value = new vxldollarapi::BlockReceiveT(*reinterpret_cast<vxldollarapi::BlockReceiveT *>(u.value));
      break;
    }
    case Block_BlockSend: {
      value = new vxldollarapi::BlockSendT(*reinterpret_cast<vxldollarapi::BlockSendT *>(u.value));
      break;
    }
    case Block_BlockChange: {
      value = new vxldollarapi::BlockChangeT(*reinterpret_cast<vxldollarapi::BlockChangeT *>(u.value));
      break;
    }
    default:
      break;
...
inline void BlockUnion::Reset() {
  switch (type) {
    case Block_BlockState: {
      auto ptr = reinterpret_cast<vxldollarapi::BlockStateT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockOpen: {
      auto ptr = reinterpret_cast<vxldollarapi::BlockOpenT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockReceive: {
      auto ptr = reinterpret_cast<vxldollarapi::BlockReceiveT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockSend: {
      auto ptr = reinterpret_cast<vxldollarapi::BlockSendT *>(value);
      delete ptr;
      break;
    }
    case Block_BlockChange: {
      auto ptr = reinterpret_cast<vxldollarapi::BlockChangeT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline bool VerifyMessage(flatbuffers::Verifier &verifier, const void *obj, Message type) {
  switch (type) {
    ...
    case Message_Error: {
      auto ptr = reinterpret_cast<const vxldollarapi::Error *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<const vxldollarapi::Success *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<const vxldollarapi::IsAlive *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<const vxldollarapi::EventAck *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockInfo *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<const vxldollarapi::AccountWeight *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<const vxldollarapi::AccountWeightResponse *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<const vxldollarapi::TopicConfirmation *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<const vxldollarapi::EventConfirmation *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<const vxldollarapi::ServiceRegister *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<const vxldollarapi::ServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<const vxldollarapi::TopicServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<const vxldollarapi::EventServiceStop *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline flatbuffers::Offset<void> MessageUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    case Message_Error: {
      auto ptr = reinterpret_cast<const vxldollarapi::ErrorT *>(value);
      return CreateError(_fbb, ptr, _rehasher).Union();
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<const vxldollarapi::SuccessT *>(value);
      return CreateSuccess(_fbb, ptr, _rehasher).Union();
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<const vxldollarapi::IsAliveT *>(value);
      return CreateIsAlive(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<const vxldollarapi::EventAckT *>(value);
      return CreateEventAck(_fbb, ptr, _rehasher).Union();
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<const vxldollarapi::BlockInfoT *>(value);
      return CreateBlockInfo(_fbb, ptr, _rehasher).Union();
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<const vxldollarapi::AccountWeightT *>(value);
      return CreateAccountWeight(_fbb, ptr, _rehasher).Union();
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<const vxldollarapi::AccountWeightResponseT *>(value);
      return CreateAccountWeightResponse(_fbb, ptr, _rehasher).Union();
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<const vxldollarapi::TopicConfirmationT *>(value);
      return CreateTopicConfirmation(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<const vxldollarapi::EventConfirmationT *>(value);
      return CreateEventConfirmation(_fbb, ptr, _rehasher).Union();
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<const vxldollarapi::ServiceRegisterT *>(value);
      return CreateServiceRegister(_fbb, ptr, _rehasher).Union();
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<const vxldollarapi::ServiceStopT *>(value);
      return CreateServiceStop(_fbb, ptr, _rehasher).Union();
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<const vxldollarapi::TopicServiceStopT *>(value);
      return CreateTopicServiceStop(_fbb, ptr, _rehasher).Union();
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<const vxldollarapi::EventServiceStopT *>(value);
...
inline MessageUnion::MessageUnion(const MessageUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case Message_Error: {
      value = new vxldollarapi::ErrorT(*reinterpret_cast<vxldollarapi::ErrorT *>(u.value));
      break;
    }
    case Message_Success: {
      value = new vxldollarapi::SuccessT(*reinterpret_cast<vxldollarapi::SuccessT *>(u.value));
      break;
    }
    case Message_IsAlive: {
      value = new vxldollarapi::IsAliveT(*reinterpret_cast<vxldollarapi::IsAliveT *>(u.value));
      break;
    }
    case Message_EventAck: {
      value = new vxldollarapi::EventAckT(*reinterpret_cast<vxldollarapi::EventAckT *>(u.value));
      break;
    }
    case Message_BlockInfo: {
      value = new vxldollarapi::BlockInfoT(*reinterpret_cast<vxldollarapi::BlockInfoT *>(u.value));
      break;
    }
    case Message_AccountWeight: {
      value = new vxldollarapi::AccountWeightT(*reinterpret_cast<vxldollarapi::AccountWeightT *>(u.value));
      break;
    }
    case Message_AccountWeightResponse: {
      value = new vxldollarapi::AccountWeightResponseT(*reinterpret_cast<vxldollarapi::AccountWeightResponseT *>(u.value));
      break;
    }
    case Message_TopicConfirmation: {
      FLATBUFFERS_ASSERT(false);  // vxldollarapi::TopicConfirmationT not copyable.
      break;
    }
    case Message_EventConfirmation: {
      FLATBUFFERS_ASSERT(false);  // vxldollarapi::EventConfirmationT not copyable.
      break;
    }
    case Message_ServiceRegister: {
      value = new vxldollarapi::ServiceRegisterT(*reinterpret_cast<vxldollarapi::ServiceRegisterT *>(u.value));
      break;
    }
    case Message_ServiceStop: {
      value = new vxldollarapi::ServiceStopT(*reinterpret_cast<vxldollarapi::ServiceStopT *>(u.value));
      break;
    }
    case Message_TopicServiceStop: {
      value = new vxldollarapi::TopicServiceStopT(*reinterpret_cast<vxldollarapi::TopicServiceStopT *>(u.value));
      break;
    }
    case Message_EventServiceStop: {
      value = new vxldollarapi::EventServiceStopT(*reinterpret_cast<vxldollarapi::EventServiceStopT *>(u.value));
      break;
    }
    default:
      break;
...
inline void MessageUnion::Reset() {
  switch (type) {
    case Message_Error: {
      auto ptr = reinterpret_cast<vxldollarapi::ErrorT *>(value);
      delete ptr;
      break;
    }
    case Message_Success: {
      auto ptr = reinterpret_cast<vxldollarapi::SuccessT *>(value);
      delete ptr;
      break;
    }
    case Message_IsAlive: {
      auto ptr = reinterpret_cast<vxldollarapi::IsAliveT *>(value);
      delete ptr;
      break;
    }
    case Message_EventAck: {
      auto ptr = reinterpret_cast<vxldollarapi::EventAckT *>(value);
      delete ptr;
      break;
    }
    case Message_BlockInfo: {
      auto ptr = reinterpret_cast<vxldollarapi::BlockInfoT *>(value);
      delete ptr;
      break;
    }
    case Message_AccountWeight: {
      auto ptr = reinterpret_cast<vxldollarapi::AccountWeightT *>(value);
      delete ptr;
      break;
    }
    case Message_AccountWeightResponse: {
      auto ptr = reinterpret_cast<vxldollarapi::AccountWeightResponseT *>(value);
      delete ptr;
      break;
    }
    case Message_TopicConfirmation: {
      auto ptr = reinterpret_cast<vxldollarapi::TopicConfirmationT *>(value);
      delete ptr;
      break;
    }
    case Message_EventConfirmation: {
      auto ptr = reinterpret_cast<vxldollarapi::EventConfirmationT *>(value);
      delete ptr;
      break;
    }
    case Message_ServiceRegister: {
      auto ptr = reinterpret_cast<vxldollarapi::ServiceRegisterT *>(value);
      delete ptr;
      break;
    }
    case Message_ServiceStop: {
      auto ptr = reinterpret_cast<vxldollarapi::ServiceStopT *>(value);
      delete ptr;
      break;
    }
    case Message_TopicServiceStop: {
      auto ptr = reinterpret_cast<vxldollarapi::TopicServiceStopT *>(value);
      delete ptr;
      break;
    }
    case Message_EventServiceStop: {
      auto ptr = reinterpret_cast<vxldollarapi::EventServiceStopT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline const flatbuffers::TypeTable *BlockSubTypeTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxldollarapi::BlockSubTypeTypeTable
  };
...
inline const flatbuffers::TypeTable *BlockTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxldollarapi::BlockStateTypeTable,
    vxldollarapi::BlockOpenTypeTable,
    vxldollarapi::BlockReceiveTypeTable,
    vxldollarapi::BlockSendTypeTable,
    vxldollarapi::BlockChangeTypeTable
  };
  static const char * const names[] = {
    "NONE",
    "BlockState",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeFilterTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxldollarapi::TopicConfirmationTypeFilterTypeTable
  };
  static const char * const names[] = {
    "all",
    "active",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxldollarapi::TopicConfirmationTypeTypeTable
  };
  static const char * const names[] = {
    "active_quorum",
    "active_confirmation_height",
...
inline const flatbuffers::TypeTable *MessageTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxldollarapi::ErrorTypeTable,
    vxldollarapi::SuccessTypeTable,
    vxldollarapi::IsAliveTypeTable,
    vxldollarapi::EventAckTypeTable,
    vxldollarapi::BlockInfoTypeTable,
    vxldollarapi::AccountWeightTypeTable,
    vxldollarapi::AccountWeightResponseTypeTable,
    vxldollarapi::TopicConfirmationTypeTable,
    vxldollarapi::EventConfirmationTypeTable,
    vxldollarapi::ServiceRegisterTypeTable,
    vxldollarapi::ServiceStopTypeTable,
    vxldollarapi::TopicServiceStopTypeTable,
    vxldollarapi::EventServiceStopTypeTable
  };
  static const char * const names[] = {
    "NONE",
    "Error",
...
inline const flatbuffers::TypeTable *TopicConfirmationTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxldollarapi::TopicConfirmationOptionsTypeTable
  };
  static const char * const names[] = {
    "unsubscribe",
    "options"
...
inline const flatbuffers::TypeTable *EventConfirmationTypeTable() {
  ...
  static const flatbuffers::TypeFunction type_refs[] = {
    vxldollarapi::TopicConfirmationTypeTypeTable,
    vxldollarapi::BlockTypeTable,
    vxldollarapi::ElectionInfoTypeTable
  };
  static const char * const names[] = {
    "confirmation_type",
    "account",
...
inline const vxldollarapi::Envelope *GetEnvelope(const void *buf) {
  return flatbuffers::GetRoot<vxldollarapi::Envelope>(buf);
}

inline const vxldollarapi::Envelope *GetSizePrefixedEnvelope(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<vxldollarapi::Envelope>(buf);
}
...
inline bool VerifyEnvelopeBuffer(
  ...
  return verifier.VerifyBuffer<vxldollarapi::Envelope>(nullptr);
}

inline bool VerifySizePrefixedEnvelopeBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<vxldollarapi::Envelope>(nullptr);
}

inline void FinishEnvelopeBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<vxldollarapi::Envelope> root) {
  fbb.Finish(root);
}
...
inline std::unique_ptr<vxldollarapi::EnvelopeT> UnPackEnvelope(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<vxldollarapi::EnvelopeT>(GetEnvelope(buf)->UnPack(res));
}

inline std::unique_ptr<vxldollarapi::EnvelopeT> UnPackSizePrefixedEnvelope(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<vxldollarapi::EnvelopeT>(GetSizePrefixedEnvelope(buf)->UnPack(res));
}

}  // namespace vxldollarapi

#endif  // FLATBUFFERS_GENERATED_VXLDOLLARAPI_VXLDOLLARAPI_H_
