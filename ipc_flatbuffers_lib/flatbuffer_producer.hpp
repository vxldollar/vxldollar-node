...
namespace ipc
{
	/** Produces Vxldollar API compliant Flatbuffers from objects and builders */
	...
	public:
		...
		{
			vxldollar::ipc::flatbuffer_producer producer;
		...
		auto make_envelope (flatbuffers::Offset<T> obj)
		{
			...
			vxldollarapi::EnvelopeBuilder envelope_builder (*fbb);
			...
			envelope_builder.add_message_type (vxldollarapi::MessageTraits<T>::enum_value);
