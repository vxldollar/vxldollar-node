...
public:
	timer () = default;
	timer (vxldollar::timer_state state_a, std::string const & description_a = "timer");
	...
	vxldollar::timer_state current_state () const;

private:
	timer * parent{ nullptr };
	std::vector<timer> children;
	vxldollar::timer_state state{ vxldollar::timer_state::stopped };
	std::string desc;
